...
__title__        = "jtypes.rubicon"
__summary__      = "A bridge interface between Python and Java " \
                   "(ctypes/cffi-based rubicon-java)"
__uri__          = "http://pypi.python.org/pypi/jtypes.rubicon/"
